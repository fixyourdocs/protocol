...
| [`repo-file.json`](repo-file.json) | A report whose `doc_url` is a repository file view (`github.com/<owner>/<repo>/blob/HEAD/<path>`), which a server may route by repository path (§3, §5.2). | valid |
